  ...
  _createClass(ResponseUtil, null, [{
    ...
    value: function failed(res, err) {
      var errorMessage = null,
          errorCode = null;
      if (err) {
        errorCode = err.getErrorCode() || _errorCodes2.default.INTERNAL_ERROR;
        errorMessage = err.getErrorMessage() || _CommonUtil2.default.getErrorMessage(errorCode) || 'INTERNAL_ERROR';
